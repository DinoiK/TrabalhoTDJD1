...
namespace MonoGame2
{
    ...
    {      
        ...
        public Cover menuBk, victoryBk, gameOverBk, storyBk, sequelBk, bossBk, finBk;
        ...
        protected override void LoadContent()
        {
           ...
           spriteBatch = new SpriteBatch(GraphicsDevice);
            ...
            storyBk = new StoryCover(this, "StoryBk", Art.StoryBk);
            sequelBk = new SequelCover(this, "theEnd", Art.SequelBk);
            bossBk = new BossCover(this, "bucko", Art.BossFightBk);
            finBk = new Fin(this, "fin", Art.FinBk);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if(PlayerStatus.trueEnding && !(_currentState is FinState))
                _currentState = new FinState(this, graphics.GraphicsDevice, Content);
